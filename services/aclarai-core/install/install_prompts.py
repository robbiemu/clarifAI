...
# Import the prompt installer from the installed aclarai_shared package
# This assumes the workspace is set up correctly with `pip install -e shared/`
try:
    from aclarai_shared.utils.prompt_installer import (
...
def main():
    parser = argparse.ArgumentParser(
        description="Install default prompt templates for aclarai"
    )
    parser.add_argument(
        "--template",
