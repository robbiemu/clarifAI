...
class TestImportStatus:
    ...
    def test_init(self):
        ...
        assert status.summary_stats == {"imported": 0, "failed": 0, "fallback": 0, "skipped": 0}
...
class TestEdgeCases:
    ...
    def test_format_detection_case_insensitive(self):
        ...
        detector_upper, status_upper = detect_file_format("/path/to/FILE.JSON", "FILE.JSON")
        detector_lower, status_lower = detect_file_format("/path/to/file.json", "file.json")
