...
class TestUIConfig:
    ...
    def test_default_config(self):
        ...
        assert config.logs_path == ".clarifai/import_logs"
    ...
    def test_from_env_with_defaults(self):
        ...
        env_vars = [
            "CLARIFAI_TIER1_PATH", "CLARIFAI_SUMMARIES_PATH", 
            "CLARIFAI_CONCEPTS_PATH", "CLARIFAI_LOGS_PATH",
            "CLARIFAI_UI_HOST", "CLARIFAI_UI_PORT", "CLARIFAI_UI_DEBUG"
        ]
        for var in env_vars:
    ...
    def test_from_env_with_custom_values(self):
        ...
        os.environ["CLARIFAI_TIER1_PATH"] = "custom/tier1"
        os.environ["CLARIFAI_SUMMARIES_PATH"] = "custom/summaries"
        os.environ["CLARIFAI_CONCEPTS_PATH"] = "custom/concepts"
        os.environ["CLARIFAI_LOGS_PATH"] = "custom/logs"
        os.environ["CLARIFAI_UI_HOST"] = "127.0.0.1"
        os.environ["CLARIFAI_UI_PORT"] = "8080"
        os.environ["CLARIFAI_UI_DEBUG"] = "true"
        ...
        try:
            ...
            for var in ["CLARIFAI_TIER1_PATH", "CLARIFAI_SUMMARIES_PATH", 
                       "CLARIFAI_CONCEPTS_PATH", "CLARIFAI_LOGS_PATH",
                       "CLARIFAI_UI_HOST", "CLARIFAI_UI_PORT", "CLARIFAI_UI_DEBUG"]:
                if var in os.environ:
                    del os.environ[var]
