...
class TestValidationFunctions:
    ...
    def test_validate_threshold_valid(self):
        ...
        for threshold in valid_thresholds:
            ...
            assert is_valid, f"Threshold {threshold} should be valid but got error: {error}"
            assert error == ""
    ...
    def test_validate_window_param_valid(self):
        ...
        for param in valid_params:
            ...
            assert is_valid, f"Window param {param} should be valid but got error: {error}"
            assert error == ""
