...
from clarifai_core.dirty_block_consumer import DirtyBlockConsumer
...
class TestDirtyBlockConsumer:
    ...
    def test_extract_clarifai_blocks(self, consumer):
        """Test extraction of clarifai blocks from markdown content."""
        content = """
Some text before.

This is a claim. <!-- clarifai:id=clm_abc123 ver=2 -->
^clm_abc123

Another claim here. <!-- clarifai:id=clm_def456 ver=1 -->
^clm_def456
...
"""
    ...
    @patch("clarifai_core.dirty_block_consumer.Path.exists")
    @patch("builtins.open")
...
This is the target claim. <!-- clarifai:id=clm_target ver=2 -->
^clm_target

Another claim. <!-- clarifai:id=clm_other ver=1 -->
^clm_other
"""
        ...
        assert block["clarifai_id"] == "clm_target"
    ...
    @patch("clarifai_core.dirty_block_consumer.datetime")
    def test_update_block_increments_version(self, mock_datetime, consumer):
        ...
        assert call_args[1]["clarifai_id"] == "clm_increment"
