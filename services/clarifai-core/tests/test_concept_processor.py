...
into the clarifai-core service.
"""
...
class TestConceptProcessor:
    ...
    def concept_processor(self, mock_config):
        ...
        with patch('clarifai_core.concept_processor.NounPhraseExtractor'), \
    ...
    def test_process_block_for_concepts_success(self, concept_processor, sample_block):
        ...
        # Configure mocks
        concept_processor.noun_phrase_extractor.extract_from_text.return_value = mock_extraction_result
        concept_processor.candidates_store.store_candidates.return_value = 2
        concept_processor.concept_detector.process_candidates_batch.return_value = mock_detection_batch
        ...
        assert result["clarifai_id"] == "blk_test_123"
    ...
    def test_process_block_for_concepts_no_extraction(self, concept_processor, sample_block):
    ...
    def test_process_block_for_concepts_extraction_error(self, concept_processor, sample_block):
    ...
    def test_process_block_for_concepts_exception_handling(self, concept_processor, sample_block):
        """Test exception handling during processing."""
        # Mock exception during extraction
        concept_processor.noun_phrase_extractor.extract_from_text.side_effect = Exception("Test error")
    ...
    def test_build_concept_index(self, concept_processor):
        ...
        concept_processor.concept_detector.build_index_from_candidates.return_value = 100
        ...
        # Verify the result
        assert result == 100
        concept_processor.concept_detector.build_index_from_candidates.assert_called_once_with(False)

    def test_build_concept_index_force_rebuild(self, concept_processor):
        """Test force rebuilding the concept index."""
        # Mock the detector's build method
        concept_processor.concept_detector.build_index_from_candidates.return_value = 150
        ...
        # Verify the result
        assert result == 150
        concept_processor.concept_detector.build_index_from_candidates.assert_called_once_with(True)
