...
class ConceptFileWriter:
    ...
    def __init__(self, config: Optional[ClarifAIConfig] = None):
        ...
        concepts_path = self.config.paths.concepts or "concepts"  # Default to "concepts" if not set
    ...
    def _generate_concept_filename(self, concept_text: str) -> str:
        ...
        safe_name = "".join(c if c.isalnum() or c in "._- " else "_" for c in concept_text)
    ...
    def _generate_concept_content(self, concept: Concept) -> str:
        ...
        lines = [
            ...
            "",
            f"This concept was automatically extracted and promoted from processed content.",
            "",
            "### Examples",
