...
class ClaimifyContext:
    ...
    preceding_sentences: List[SentenceChunk] = field(default_factory=list)  # p sentences
    following_sentences: List[SentenceChunk] = field(default_factory=list)  # f sentences
