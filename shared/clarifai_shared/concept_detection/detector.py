...
from ..noun_phrase_extraction.concept_candidates_store import ConceptCandidatesVectorStore
...
class ConceptDetector:
    ...
    def detect_concept_action(self, candidate: NounPhraseCandidate) -> ConceptDetectionResult:
        """
        ...
        try:
            ...
            if best_match and best_match.similarity_score >= self.similarity_threshold:
                ...
                if best_match:
                    ...
                    confidence = 1.0 - best_match.similarity_score  # Higher confidence if very different
                else:
    ...
    def process_candidates_batch(self, candidates: List[NounPhraseCandidate]) -> ConceptDetectionBatch:
        """
