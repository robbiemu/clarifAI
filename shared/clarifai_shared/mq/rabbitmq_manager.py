"""
Shared RabbitMQ connection manager for ClarifAI services.
...
class RabbitMQManager:
    ...
    def __init__(self, config: ClarifAIConfig, service_name: str = "clarifai"):
        """
        Initialize the RabbitMQ manager.

        Args:
            config: ClarifAI configuration instance
