...
module_path = os.path.join(os.path.dirname(__file__), '../../clarifai_shared/graph/models.py')
...
class TestDataclassEquality:
    ...
    def test_claim_input_equality(self):
        ...
        claim3 = ClaimInput(text="Different text", block_id="block_1", claim_id="same_id")
    ...
    def test_sentence_input_equality(self):
        ...
        sentence1 = SentenceInput(text="Same text", block_id="block_1", sentence_id="same_id")
        sentence2 = SentenceInput(text="Same text", block_id="block_1", sentence_id="same_id")
        sentence3 = SentenceInput(text="Different text", block_id="block_1", sentence_id="same_id")
