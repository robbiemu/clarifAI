...
class TestSelectionAgent(unittest.TestCase):
    ...
    def test_context_window_building(self):
        ...
        self.assertIn("[0] The system reported an error when processing the request. ← TARGET", context_text)
    ...
    def test_agent_with_mock_llm(self):
        ...
        mock_llm = MockLLM('{"selected": true, "confidence": 0.8, "reasoning": "Contains error information"}')
...
class TestDisambiguationAgent(unittest.TestCase):
    ...
    def test_verb_starter_subject_addition(self):
        ...
        self.assertTrue(any("subject" in change.lower() for change in result.changes_made))
...
class TestDecompositionAgent(unittest.TestCase):
    ...
    def test_atomicity_checking(self):
        ...
        self.assertFalse(self.agent._check_atomicity("The system reported an error and crashed."))
        self.assertFalse(self.agent._check_atomicity("The system worked but was slow."))
        self.assertFalse(self.agent._check_atomicity("The error occurred because of invalid input."))
    
    def test_self_containment_checking(self):
        """Test self-containment checking."""
        # Test self-contained statements
        self.assertTrue(self.agent._check_self_containment("The system reported an error."))
        self.assertTrue(self.agent._check_self_containment("The user clicked the button."))
    ...
    def test_verifiability_checking(self):
        ...
        self.assertTrue(self.agent._check_verifiability("The system reported an error."))
        self.assertTrue(self.agent._check_verifiability("The count was 42."))
        self.assertTrue(self.agent._check_verifiability("The process resulted in success."))
        ...
        self.assertTrue(self.agent._check_verifiability("Something happened."))  # Contains verifiable pattern "happened"
