...
def test_config_structure():
    ...
    try:
        ...
        for subsection in required_embedding:
            assert subsection in embedding_config, f"Missing embedding subsection: {subsection}"
...
def test_config_module():
    ...
    with patch.dict('sys.modules', {
        ...
        try:
            ...
            assert embedding_config.default_model == "sentence-transformers/all-MiniLM-L6-v2"
