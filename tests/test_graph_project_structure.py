...
class TestGraphProjectStructure:
    ...
    def test_required_files_exist(self):
        ...
        base_path = Path(__file__).parent.parent / "shared" / "clarifai_shared" / "graph"
    ...
    def test_neo4j_manager_has_required_methods(self):
        ...
        manager_path = Path(__file__).parent.parent / "shared" / "clarifai_shared" / "graph" / "neo4j_manager.py"
...
class TestGraphDataModelStructure:
    ...
    def test_claim_model_has_required_fields(self):
        ...
        assert required_fields.issubset(claim_dict.keys()), f"Missing required fields in Claim model: {required_fields - set(claim_dict.keys())}"
    ...
    def test_sentence_model_has_required_fields(self):
        ...
        required_fields = {'id', 'text', 'ambiguous', 'verifiable', 'version', 'timestamp'}
        assert required_fields.issubset(sentence_dict.keys()), f"Missing required fields in Sentence model: {required_fields - set(sentence_dict.keys())}"
