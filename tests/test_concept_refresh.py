...
def test_extract_semantic_text():
    ...
    with patch("aclarai_scheduler.concept_refresh.Neo4jGraphManager"), \
...
@patch("aclarai_scheduler.concept_refresh.EmbeddingGenerator")
@patch("aclarai_scheduler.concept_refresh.aclaraiVectorStore")
def test_process_concept_file_no_changes(mock_vector_store, mock_embedding_gen, mock_neo4j):
...
@patch("aclarai_scheduler.concept_refresh.EmbeddingGenerator") 
@patch("aclarai_scheduler.concept_refresh.aclaraiVectorStore")
def test_process_concept_file_with_changes(mock_vector_store, mock_embedding_gen, mock_neo4j):
...
@patch("aclarai_scheduler.concept_refresh.EmbeddingGenerator")
@patch("aclarai_scheduler.concept_refresh.aclaraiVectorStore")
def test_run_job_no_concepts_directory(mock_vector_store, mock_embedding_gen, mock_neo4j):
...
@patch("aclarai_scheduler.concept_refresh.EmbeddingGenerator")
@patch("aclarai_scheduler.concept_refresh.aclaraiVectorStore")
def test_run_job_with_concept_files(mock_vector_store, mock_embedding_gen, mock_neo4j):
